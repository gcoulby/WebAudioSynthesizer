            ...
            <div id="osc1" class="osc">
                ...
                <div class="waveForm">
                    ...
                    <div class="ledLabel">
                        ...
                        <label for="osc1Led0"><span></span><img src="img/synth/sine.png" alt="sine wave"></label>
                    </div>
                    ...
                    <div class="ledLabel">
                        ...
                        <label for="osc1Led1"><span></span><img src="img/synth/square.png" alt="square wave"></label>
                    </div>

                    <div class="ledLabel">
                        <input type="radio" id="osc1Led2" data-position="2" name="osc1Led" data-waveform="sawtooth" data-osc="1" onclick="setWaveForm(this)">
                        <label for="osc1Led2"><span></span><img src="img/synth/sawtooth.png" alt="sawtooth wave"></label>
                    </div>

                    <div class="ledLabel">
                        <input type="radio" id="osc1Led3" data-position="3" name="osc1Led" data-waveform="triangle" data-osc="1" onclick="setWaveForm(this)">
                        <label for="osc1Led3"><span></span><img src="img/synth/triangle.png" alt="triangle wave"></label>
                    </div>
                    <div class="ledLabel">
            ...
            <div id="osc2" class="osc">
                ...
                <div class="waveForm">
                    ...
                    <div class="ledLabel">
                        ...
                        <label for="osc2Led0"><span></span><img src="img/synth/sine.png" alt="sine wave"></label>
                    </div>

                    <div class="ledLabel">
                        <input type="radio" id="osc2Led1" data-position="1" name="osc2Led" data-waveform="square" data-osc="2" onclick="setWaveForm(this)">
                        <label for="osc2Led1"><span></span><img src="img/synth/square.png" alt="square wave"></label>
                    </div>
                    ...
                    <div class="ledLabel">
                        ...
                        <label for="osc2Led2"><span></span><img src="img/synth/sawtooth.png" alt="sawtooth wave"></label>
                    </div>

                    <div class="ledLabel">
                        <input type="radio" id="osc2Led3" data-position="3" name="osc2Led" data-waveform="triangle" data-osc="2" onclick="setWaveForm(this)">
                        <label for="osc2Led3"><span></span><img src="img/synth/triangle.png" alt="triangle wave"></label>
                    </div>
                    <div class="ledLabel">
                        <div class="buttonDrop">
